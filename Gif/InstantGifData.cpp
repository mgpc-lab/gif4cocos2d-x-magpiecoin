...
std::string InstantGifData::getGifFrameName(int index)
{
	...
	return (m_gif_fullpath + "_instant_" + std::to_string(m_instantGifId)).c_str();   //cocos2d::CCString::createWithFormat("%s_instant_%u",m_gif_fullpath.c_str(),m_instantGifId)->getCString();
}
